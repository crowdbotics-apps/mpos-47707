"""
Django settings for mpos_47707 project.
...
WSGI_APPLICATION = 'mpos_47707.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mpos_47707 API",
    "DESCRIPTION": "API documentation for mpos_47707 App",
    "VERSION": "v1",
}
